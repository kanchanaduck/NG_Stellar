...
export class SettingsPanelComponent implements OnInit {
  ...
  changeSidebarTheme(theme) {
    ...
    if (theme === "dark") {
      ...
      document.querySelector('.logo-dark').classList.remove("d-block","d-none");
      document.querySelector('.logo-light').classList.remove("d-block","d-none");
      document.querySelector('.logo-dark').classList.add('d-block');
      ...
      document.querySelector('.logo-light').classList.add('d-block');
    }
  }
